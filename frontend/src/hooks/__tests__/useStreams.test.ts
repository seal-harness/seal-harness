  ...
  it('populates tabs + sessions from a lists snapshot', () => {
    ...
    act(() => {
      c.pushLists({
        ...
        recentSessions: [{ id: 's2', agent: null, repoUrl: null, runtime: 'r', model: 'm', lastActive: 't', createdAt: 't', description: null, autoSummary: null, firstMessageSnippet: null, channel: null, channelUserId: null, lastUserMessageAt: null }],
        archivedSessions: [],
        tabSessions: [],
      })
    })
