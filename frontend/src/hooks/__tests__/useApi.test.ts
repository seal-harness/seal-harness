...
describe('useRecentSessions', () => {
  it('fetches GET /api/sessions on mount', async () => {
    setNextResponse([{ id: 's1', agent: null, runtime: 'session:anthropic', model: 'm', lastActive: 't', createdAt: 't', description: null, autoSummary: null, firstMessageSnippet: null, channel: 'cli', channelUserId: null, lastUserMessageAt: null, repoId: null }])
...
describe('useListsPoll', () => {
  it('fetches GET /api/lists on mount and returns the four arrays + error=false', async () => {
    ...
    const sess = { id: 's2', agent: null, runtime: 'session:anthropic', model: 'm', lastActive: 't', createdAt: 't', description: null, autoSummary: null, firstMessageSnippet: null, channel: 'cli', channelUserId: null, lastUserMessageAt: null, repoId: null }
