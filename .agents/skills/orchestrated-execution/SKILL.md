...
```bash
# Create work unit documents under the epic
# Each WU gets a markdown file in docs/plans/ with:
#   title, spec section, DoD items, file scope, checkpoint flag, and dependencies
#
# WU-001: <title> — depends on: (none)
# WU-002: <title> — depends on: (none)
# WU-003: <title> — depends on: WU-001, WU-002
```
