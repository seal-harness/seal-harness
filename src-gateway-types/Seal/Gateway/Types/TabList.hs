...
-- ADTs.
--
-- Canonical home; 'Seal.Tabs.Types' in the server re-exports from here.
...
import Seal.Gateway.Types.MessageSource (ConversationId)
import Seal.Gateway.Types.Core (SessionId)
import Seal.Gateway.Types.Tab (TabIndex (..), TabKind, mkTabIndex)
import Seal.Gateway.Types.HarnessId (HarnessId)
