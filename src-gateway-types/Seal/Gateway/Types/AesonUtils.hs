...
--
-- Canonical home; 'Seal.Util.AesonUtils' in the server re-exports from
-- here.
...
-- ---------------------------------------------------------------------------
-- Minimal inline of the bits of @Text.Casing@ the @lensy*Snake@/@lens*Kebab@
...
lensyFieldNameToSnakeJson = toQuietSnake . fromHumps . dropWhile (=='_') . dropWhile (/='_') . dropWhile (=='_')
...
lensyFieldNameToKebabJson = toKebab . fromHumps . dropWhile (=='_') . dropWhile (/='_') . dropWhile (=='_')
