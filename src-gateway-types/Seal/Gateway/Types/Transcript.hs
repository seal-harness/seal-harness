...
--
-- Canonical home; 'Seal.Transcript.Types' in the server re-exports from
-- here.
...
import Seal.Gateway.Types.Core (ModelId)
import Seal.Gateway.Types.AesonUtils (stripPrefixToJSON, stripPrefixParseJSON)
